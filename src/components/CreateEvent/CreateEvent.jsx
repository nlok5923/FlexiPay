      ...
      <div className='ce-div'>
        ...
        <Form className='ce-form' form={form} layout={'vertical'}>
          ...
          <Form.Item className='ce-form-label' label='Event RSVP Fee' name='eventRsvpFee' rules={[{ required: true }]}>
            <Input type="number" min="0.000000000000000001" step="0.000000000000000001" typeplaceholder='Enter the RSVP fee in ETH...' name="Event RSVP Fee" onChange={(e)=>onChangeHandler(e)} />
          </Form.Item>
